package cn.droidlover.xdroidmvp.net.download;
...
import cn.droidlover.xdroidmvp.net.download.db.DownloadDBManager;
import cn.droidlover.xdroidmvp.net.listener.DownloadListener;
import cn.droidlover.xdroidmvp.net.task.PriorityAsyncTask;
